...
- **Massively scaling human feedback**. The Instruct-GPT variants feel much easier to interact with
  ...
  help.
    - Comment: After this post was first published, DeepMind announced
      [Sparrow](https://www.deepmind.com/blog/building-safer-dialogue-agents), focusing on improving
      the kind of human feedback used for RLHF.
