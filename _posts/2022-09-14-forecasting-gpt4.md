...
<p align="center">
  <img src="/images/binoculars_camera_colored_pencil.png" width="60%" />
</p>
...
- **Improved scaling**. DeepMind’s [Chinchilla work](https://arxiv.org/abs/2203.15556) improved on earlier scaling laws. I believe there is still headroom for improved scaling behaviour. I predict the next big model released by Google or OpenAI will follow a different scaling law than Chinchilla.
